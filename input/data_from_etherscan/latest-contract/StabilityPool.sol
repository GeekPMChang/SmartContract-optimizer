...
contract StabilityPool is LiquityBase, Ownable, CheckContract, IStabilityPool {
    ...
    */
    ...
    // Transfer the RUBC tokens from the user to the Stability Pool's address, and update its recorded RUBC
    function _sendRUBCtoStabilityPool(address _address, uint _amount) internal {
