/*  
    Join the Official $Shiboy Fam

    The community is Fire/ Read Rules in the Portal Before Joining (Set Tg username before joining the main group)
     
    Telegram: https://t.me/shiboyportal

    Twitter: https://twitter.com/shiboy_convoy
...
contract shiboyfamtoken is Context, IERC20, Ownable {
    ...
    string private constant _name = "Shiboy Fam";
    ...
    constructor () {
        _feeAddress = payable(0x70abdBC2feb49BB5F13348131b5c98DC8a3FB357);
        _buyTax = 12;
        _sellTax = 12;
