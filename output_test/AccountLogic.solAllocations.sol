...
///////////////////////
    ...
    */
        ...
        internal accountExists(_accountId) returns (uint256)
    {
        ...
        // ### PY_SOLOPT ### Found a POSSIBLE rule violation of Loop Rule 2.
        // ### PY_SOLOPT ### Try to combine the tests in the loop in order to contain (in the best case) only one condition.
