...
contract ERC1271Bytes is ERC1271 {
    ...
    * MUST allow external calls
    */
    // ############ PY_SOLOPT: Found a POSSIBLE instance of a recursive procedure. Please verify.   ############
    // ############ PY_SOLOPT: If this is the case, remove recursion in order to decrease gas cost. ############
...
contract Agent is IERC165, ERC1271Bytes, IForwarder, IsContract, Vault {
    ...
    */
        ...
        authP(EXECUTE_ROLE, arr(_target, _ethValue, uint256(_getSig(_data)))) // bytes4 casted as uint256 sets the bytes as the LSBs
    {
        ...
        // ############ PY_SOLOPT: Found instance of an unnecessary boolean variable. ############
        if (_target.call.value(_ethValue)(_data)) {
